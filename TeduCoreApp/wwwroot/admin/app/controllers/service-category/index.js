var dichvuCategoryController = function () {
    ...
    function registerEvents() {
        ...
        $('body').on('click', '#btnEdit', function (e) {
            ...
            $.ajax({
                type: "GET",
                url: "/Admin/DichVuCategory/GetById",
                data: { id: that },
                dataType: "json",
                beforeSend: function () {
                    tedu.startLoading();
        ...
        $('body').on('click', '#btnDelete', function (e) {
            ...
            tedu.confirm('Are you sure to delete?', function () {
                $.ajax({
                    type: "POST",
                    url: "/Admin/DichVuCategory/Delete",
                    data: { id: that },
                    dataType: "json",
                    beforeSend: function () {
                        tedu.startLoading();
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/Admin/DichVuCategory/SaveEntity",
                    data: {
                        Id: id,
                        Name: name,
    ...
    function initTreeDropDownCategory(selectedId) {
        $.ajax({
            url: "/Admin/DichVuCategory/GetAll",
            type: 'GET',
            dataType: 'json',
            async: false,
            success: function (response) {
    ...
    function loadData() {
        $.ajax({
            ...
            success: function (response) {
                ...
                var $tree = $('#treeDichVuCategory');

                $('#treeDichVuCategory').tree({
                    data: treeArr,
                    dnd: true,
                    ...
                    onDrop: function (target, source, point) {
                        ...
                        if (point === 'append') {
                            ...
                            //Update to database
                            $.ajax({
                                url: '/Admin/DichVuCategory/UpdateParentId',
                                type: 'post',
                                dataType: 'json',
                                data: {
                                    sourceId: source.id,
                            ...
                            $.ajax({
                                url: '/Admin/DichVuCategory/ReOrder',
                                type: 'post',
                                dataType: 'json',
                                data: {
                                    sourceId: source.id,
