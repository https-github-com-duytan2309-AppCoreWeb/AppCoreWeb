var SizeController = function () {
    ...
    function registerEvents() {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/Admin/ProductSize/SaveEntity",
                    data: {
                        Id: id,
                        Code: code,
                        Name: name
                    ...
                    success: function (response) {
                        tedu.notify('Save size successful', 'success');
    ...
    function loadData(isPageChanged) {
        $.ajax({
            type: "GET",
            url: "/Admin/ProductSize/GetAllPaging",
            data: {
