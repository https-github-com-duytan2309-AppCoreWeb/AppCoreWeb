...
namespace TeduCoreApp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(
            ...
            IEmailSender emailSender, GooglereCaptchaService googleservice,
        ...
        {
            //var capservice = _googleservice.VerifyCaptcha(model.Token);

            //if (!capservice.Result.success && capservice.Result.score <=0.5)
            //{
            //    ModelState.AddModelError(string.Empty,"You are not Humman");
            //    return View(model);
            //}
            ViewData["ReturnUrl"] = returnUrl;
            if (ModelState.IsValid)
            {
                ...
                {
                    _logger.LogWarning("Đăng xuất tài khoản .");
