...
namespace TeduCoreApp.Controllers
{
    ...
    public class BillDetailsController : Controller
    {
        ...
        public BillDetailsController(AppDbContext context, UserManager<AppUser> userManager, IBillService billService, IHostingEnvironment hostingEnvironment, IProductService productServices)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (id != null)
            {
                var appDbContext = _context.BillDetails.Include(b => b.Bill).Include(b => b.Color).Include(b => b.Product).Include(b => b.Size).Where(b => b.Bill.CustomerId.ToString() == id.ToString());
        ...
        //[HttpGet]
        //public IActionResult GetByDetailProduct(int idBill)
        //{
        //    var id = _billService.GetBillDetails(idBill);
        //    var id =
