...
namespace TeduCoreApp.Models
{
    public class HomeViewModel
    {
        ...
        public List<DichVuCategoryViewModel> LastestDichVuCategory { get; set; }
        public List<DichVuViewModel> LastestDichVu { get; set; }
        public List<SlideViewModel> HomeSlides { get; set; }
        public List<ProductViewModel> HotProducts { get; set; }
        public List<ProductViewModel> TopSellProducts { get; set; }
        public List<DichVuCategoryViewModel> HomeDichVuCategories { get; set; }
